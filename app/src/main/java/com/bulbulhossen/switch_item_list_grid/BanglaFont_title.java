...
public class BanglaFont_title extends TextView {
    ...
    public BanglaFont_title(Context context) {
        super(context);
    ...
    public BanglaFont_title(Context context, AttributeSet attrs) {
        super(context, attrs);
        if (isInEditMode()) {
            return;
        }
    ...
    public BanglaFont_title(Context context, AttributeSet attrs, int defStyle) {
